...
namespace ClassScheduler
{
    ...
    {
        List<SingleCourse> avaliableCourses;
        UserConfig userInfo;

        public CourseSelectionForm(InitialInputForm userDataForm)
        {
            userInfo = userDataForm.userData;
            avaliableCourses = new List<SingleCourse>(userDataForm.courses);
            InitializeComponent();
        }
        ...
        {
            AddCourseForm CourseAdd = new AddCourseForm();
        ...
        private void CourseSelectionForm_Load(object sender, EventArgs e)
        {
            ...
            CourseSelectionLabel.Text = "Welcome " + userInfo.firstName + ", please enter your " + fullTermName + " course(s)... ";
        }
    }
}
